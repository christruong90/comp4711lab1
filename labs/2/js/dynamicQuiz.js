var quiz = [
		{
			question:"<p> 1) Which code snippet can be used to create a new Date Object?</p>" +
					"<form>" +
						"<input type=\"radio\" name=\"q1\"> <span style =\"color:purple\">new </span>Date() <br>" +
		...
		},
		{
			...
			"<form>" +
				"<input type=\"radio\" name=\"q2\"> <span style =\"color:red\">\"==\"</span> is comparison and <span style =\"color:red\">\"===\"" +
				"</span> is assignment <br>" +
				"<input type=\"radio\" name=\"q2\"> <span style =\"color:red\">\"==\"</span> is assignment and <span style =\"color:red\">\"" + "===\"" +
				"</span> is comparison <br>" +
				"<input type=\"radio\" name=\"q2\"> <span style =\"color:red\">\"==\"</span> will check comparison after conversion of data types" +  
				"and <span style =\"color:red\">\"===\"</span> will compare without conversion of data type <br>" +
				"<input type=\"radio\" name=\"q2\"> They are the both identical <br>" +	
			"</form>",
			answer: 2		
		},
		{
			question:"<p> 3) What will be the output of the following code snippet?</p><br>" +
				...
				"<span style =\"color:blue\">console</span>.log(color);<br>" +
		...
		},
		{
			...
			"<form>" +
				"<input type=\"radio\" name=\"q4\"> Match <br>" +
				"<input type=\"radio\" name=\"q4\"> No Match <br>" +
				"<input type=\"radio\" name=\"q4\"> Undefined <br>" +
				"<input type=\"radio\" name=\"q4\"> NaN <br>" +	
			"</form>",
			answer: 4 
		}, 
		{ 
			...
			"<form>" +
				"<input type=\"radio\" name=\"q5\"> <span style =\"color:green\">var</span> x = global scope and <span style =\"color:green\">var</span> y = local scope <br>" +
